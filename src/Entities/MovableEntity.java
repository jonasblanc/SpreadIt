...
public abstract class MovableEntity extends Entity {
	...
	/**
	 * Moves the entity towards its goal by number of steps it is allowed in a move Must be called
	 * by Update
	 */
	...
	private boolean moveTowardDir(Dir direction) {
		switch (direction) {
		case UP:
			return moveTo(super.getPosX(), super.getPosY() + 1);
		case DOWN:
			return moveTo(super.getPosX(), super.getPosY() - 1);
		case LEFT:
			return moveTo(super.getPosX() - 1, super.getPosY());
		case RIGHT:
			return moveTo(super.getPosX() + 1, super.getPosY());
		default:
			return false;
